...
public class LoginActivity extends AppCompatActivity {
    ...
    protected  void onCreate(Bundle savedInstanceState) {
        ...
        final EditText username = findViewById(R.id.et_login_username);
        final EditText password = findViewById(R.id.et_login_password);
        final Button btn_sign_in = findViewById(R.id.btn_signin);
